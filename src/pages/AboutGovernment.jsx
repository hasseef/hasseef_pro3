    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">
            طبقة تشغيل قياسية للجهات الحكومية وإمارات المناطق وهيئات التطوير
            لربط الحلول والمشاريع والفعاليات بالرؤية 2030 ومؤشرات الأداء.
          </div>
        </div>
      </div>
      ...
      <section className="card" style={{ marginBottom: "1rem" }}>
        ...
        <div className="card-sub">
          يدعم حساب الجهة الحكومية وحساب الإمارة وهيئة التطوير مجالات التخطيط، واستقبال الحلول،
          وتحويلها إلى مشاريع وبرامج، وربطها بالأهداف الاستراتيجية، مع متابعة التنفيذ والأثر.
        </div>
